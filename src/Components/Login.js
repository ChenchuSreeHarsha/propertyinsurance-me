...
import { regexEmail, regexMobileNo, regexUsername } from './RegularExpressions';
          ...
          <form onSubmit={HandleSubmit} className='form-inline border rounded bg-light me-lg-4 shadow mt-5'>
              ...
              <div className='mx-lg-2 my-3 px-2'>
                  ...
                  <div>
                     <div className='ms-2 mt-2'>
                      ...
                      {[...Array(4)].map((_, index) => (
                       ...
                       <button className='btn btn-info text-nowrap fw-bold shadow ms-1' onClick={handleVerifyMobileNoOtp}>Login</button><br/>
                      </form>
                ...
                {/* <div className='mt-lg-3 d-flex justify-content-center'> */}
                    ...
                    {/* {
                    verifyotp === "Verified Successfully" &&<button className='btn btn-primary fw-bold shadow'>Login <LoginSharpIcon className='text-dark'/></button>
                    }  */}
                    {/* {
