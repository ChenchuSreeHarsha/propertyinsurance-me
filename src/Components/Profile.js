...
console.log(signUpDetails,contact.mobileno)
    ...
    const HandleInvoice=(paymentId)=>{
        // var paymentID = paymentDetails[index]?.paymentId;
        console.log(paymentId);
        PropertyInsuranceService.invoiceDownload(paymentId).then((res)=>
        {}).catch((error)=>{});
    }

    function HandleInvoiceDownLoad(index)
    {
        console.log("hijhb");
    }
    console.log(address)
                            ...
                            <div className="card shadow mt-3 fillOutPage">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className='d-flex justify-content-end'>
                                        <a className='btn btn-success' href={`http://122.169.207.194:9092/api/v1/create/${detail.paymentDetail.paymentId}`} download='invoice'>
    ...
    return (
        <div className='row container-fluid pay'>
            <div className='mb-5' >
                <header >
                    <div class="d-flex row py-2 rounded fixed justify-content-center align-items-center" style={{background:'#f0f8ff'}} >
                        ...
                        <div>
                        <Link to='/'><button className='btn btn-danger float-end ms-5 fw-bold py-1 mt-1'>Log Out</button></Link>
                        </div>
                        </div>
			        </div>
                </header>
            ...
            <div className='col-12 col-lg-9 col-md-8 mt-3'>
                ...
                <div className='ms-2 overflow-y-scroll pe-2' style={{height:'80vh'}}>
...
export default Profile;
    ...
    //                             </div>
    //                             <div className='d-flex justify-content-end'>
    //                                 <a className='btn btn-success' href={`http://192.168.1.3:9092/api/v1/create/${paymentDetails[index]?.paymentId}`} download='invoice'><i className="fa-solid fa-download me-2"></i>Invoice
    //                                 </a>
    //                             </div>
    //                         </div>
    //                     </div>
    ...
    //         <button className='mx-5 btn btn-link fs-5' onClick={HandleNewPolicy}>  Get new policy</button></div> */}
    //     </div>
    //     );
    // };