...
import { FormControl, InputLabel, MenuItem, Select, recomposeColor } from '@material-ui/core';
...
<div>
        ...
        <div className='mt-2 d-flex justify-content-end'>
          <button className='btn btn-primary' onClick={HandleMailInput} disabled={!year}>
            Get Mail<i className="fa-solid fa-share ms-2"></i>
          </button>
        </div>
        {/* <div className='mt-2 row d-flex justify-content-center'>
          ...
          <div className='col-3 p-2'>
            <button className='btn btn-success' onClick={HandleSendMail}>Send Mail<i className="fa-solid fa-envelope ms-2"></i></button>
          </div>
        </div> */}
    </div>
              ...
              <form onSubmit={handleClick}>
                 <TextField
                  ...
                  <TextField
                    ...
                    <button className='btn btn-success px-3 py-2 rounded mt-2 fw-bold shadow verification' onClick={sendemailOTP} disabled={otpSentMail}>{emailverified}</button>
                    </div>
                 ...
                 <TextField
                    ...
                    autoComplete='off'
                    /><br/>
                    <small className='overflow-scroll'>
                    {validationErrors.mobileno && <span className="text-danger  sdErrmsg">{validationErrors.mobileno}</span>}<br/></small>
                    </div>

                  <div style={{float:'right'}} className='col-12 col-lg-4'>
                    <button className='btn btn-success px-3 py-2 rounded mt-2 fw-bold shadow' onClick={sendOTP} disabled={otpSent}
                    >{mobileverified}</button>
                  </div>
