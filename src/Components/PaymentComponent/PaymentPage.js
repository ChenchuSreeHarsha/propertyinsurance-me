 ...
 const clearSessionStorage = () => {
  ...
  return (
    <div className='pay container-fluid'>
      <Header />
      <div className='mt-lg-5 mt-5 px-3 mx-md-5 pt-4'>
      ...
      <div className='col-12 col-md-9 mx-md-5 col-lg-7'>
        <div class="card border-success px-2 shadow mb-3  property" >
            ...
            <div className='d-flex flex-lg-row flex-column justify-content-around'>
              <div>
                <div className='mt-1 mt-lg-5 mx-5'>
                  <img src={RamanaLogo} alt='company-logo' title='RamanaSoft insurance' className='w-50 mx-lg-1 mx-5 rounded shadow'/>
                </div>
                <div className='mt-3'>
      ...
      <div className='col-12 col-lg-3 col-md-5'>
        <div className=''>
          <img src={safe} title="no data breeching" alt='secured data' className='w-100'/>
        </div>
      </div>
      </div>
      <div className='px-5 row'>
        <p className='text-center'>RamanaSoft Insurance Pvt.Ltd located at Aditya Trade center, Ameerpet. Hyderabad 500073.<br /> for more enquiries please contact <a href="mailto:ramanasoftpvtltd@gmail.com" target='_blank'>ramanasoftpvtltd@gmail.com</a>.</p>
      </div>
    </div>
  )
}
