...
var emailId=location.state?.emailId;
  ...
  return (
    <>
      <Header/>
    <div className='mt-lg-5 pt-lg-3 mt-5 property px-1 px-lg-2'>
          <div> <h2 className='text-center fw-bold text-success pt-lg-2 pt-5 'style={{fontFamily:'verdana'}}> PROPERTY DETAILS <RoofingIcon className='fs-1'/></h2></div>

          <form  onSubmit={handleClick} class='form-horizatol'  >
            <div className='row container-fluid'>

            
  <div className='col-12 col-lg-6 px-2 mt-3 sdborder'style={{borderRight:'6px solid #ccc',borderRadius:'4px'}}>
    ...
    <div className="form-group ms-lg-5">
      ...
      {validationErrors.marketValue && <p className="text-danger sdErrmsg mx-5 fs-6 fw-bold">{validationErrors.marketValue}</p>}</small>
    </div>
    ...
    <div className="form-group ms-lg-5 mt-3">
      ...
      {validationErrors.squareFeet && <p className="text-danger mx-5 fw-bold sdErrmsg">{validationErrors.squareFeet}</p>} <br></br>
    </div>
    ...
    <div className="form-group ms-lg-5">
      ...
      {validationErrors.pincode && <span className="text-danger mx-5 fw-bold sdErrmsg">{validationErrors.pincode}</span>}
    </div>
    ...
    <div className="form-group ms-lg-5 mt-3 fw-bold">
      ...
      <span>
        <select id='age' required name='buildingAge' style={{ borderRadius: '10px' }} value={values.buildingAge} onChange={onSubmit} className='ms-lg-2 py-2 px- fw-bold bg-light'>
  ...
  <div className="form-group ms-lg-5  mt-lg-3">
    ...
    <span>
      <select id='security' name='security' style={{ borderRadius: '10px'}} value={values.security} className='fw-bold px-lg-3 px-3 ms-lg-3 ms-4 py-2 bg-light' onChange={onSubmit} required>
        <option value="">Select</option>
        <option value="Yes">Yes</option>
        <option value="No">No</option>
      </select>
  ...
  <div className="form-group ms-lg-5">
    ...
    <span>
      <select className='px-3 ms-lg-3 ms-4 py-2 fw-bold bg-light' id='person' style={{ borderRadius: '10px' }} name='person' value={values.person} onChange={onSubmit} required>
        <option value="">Select</option>
        <option value="Yes">Yes</option>
        <option value="No">No</option>
      </select>
...
<div className='rounded pb-0 mt-3 bg-dark-subtle'>
